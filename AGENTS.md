...
- `cloudflare-api/wrangler.toml` is deploy truth for the `finance-api` Worker; `web_ui/` deploys to the `finance-web-ui` Cloudflare Pages project. The monorepo no longer provisions Render resources.
