...
const messages = {
  ...
  'zh-Hans': {
    ...
    healthTitle: '服务心跳', lastChecked: '最后检查：{time} · 每 30 秒自动刷新', refresh: '刷新', healthy: '正常', down: '不可用', core: '核心', dataProviders: '数据源', checking: '检查中…', status: '状态', configValid: '配置有效', cache: '缓存', languageModel: '大语言模型', available: '可用', unavailable: '不可用', unreachable: '无法连接', reachable: '可连接', evidence: '证据', job: '任务', analyst: '分析服务',
  ...
  'zh-Hant-HK': {
    ...
    healthTitle: '服務狀態', lastChecked: '最後檢查：{time} · 每 30 秒自動更新', refresh: '重新整理', healthy: '正常', down: '無法運作', core: '核心', dataProviders: '資料供應商', checking: '檢查中…', status: '狀態', configValid: '設定有效', cache: '快取', languageModel: 'LLM', available: '可用', unavailable: '不可用', unreachable: '無法連接', reachable: '可連接', evidence: '證據', job: '工作', analyst: '分析服務',
