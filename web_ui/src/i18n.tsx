...
const messages = {
  en: {
    ...
    conflictSummaryExternal: "Vincent's technical engine calls {technicalDirection}, but Ryan's fundamental, sentiment and macro context leans {fundamentalDirection}.",
    ...
    summaryVincent: 'Vincent: {action} ({priceState})', summaryHurdleBeats: 'beats {benchmarks}', summaryHurdleLags: 'does not beat {benchmarks}',
  ...
  'zh-Hans': {
    ...
    conflictSummaryExternal: 'Vincent 的技术引擎给出{technicalDirection}，但 Ryan 的基本面、市场情绪与宏观面综合来看倾向{fundamentalDirection}。',
    ...
    summaryVincent: 'Vincent：{action}（{priceState}）', summaryHurdleBeats: '跑赢 {benchmarks}', summaryHurdleLags: '跑不赢 {benchmarks}',
  ...
  'zh-Hant-HK': {
    ...
    conflictSummaryExternal: 'Vincent 的技術引擎給出{technicalDirection}，但 Ryan 的基本因素、市場情緒與宏觀面綜合來看傾向{fundamentalDirection}。',
    ...
    summaryVincent: 'Vincent：{action}（{priceState}）', summaryHurdleBeats: '跑贏 {benchmarks}', summaryHurdleLags: '跑不贏 {benchmarks}',
