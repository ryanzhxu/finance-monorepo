...
const messages = {
  en: {
    ...
    undervalued: 'Undervalued', demandShock: 'Demand Shock', trending: 'Trending', opportunities: 'Opportunities',
    ...
    masterVerdict: 'Full Verdict', masterVerdictConfirms: 'Matches full analysis', masterVerdictDiffers: 'Differs from full analysis',
    healthTitle: 'Service heartbeat', lastChecked: 'Last checked: {time}', refresh: 'Refresh',
    healthy: 'Healthy', down: 'Down', core: 'Core', dataProviders: 'Data providers', checking: 'Checking…', status: 'Status', configValid: 'Config valid', cache: 'Cache', languageModel: 'LLM', available: 'available', unavailable: 'unavailable', unreachable: 'unreachable', reachable: 'reachable', evidence: 'Evidence', job: 'Job',
    healthTechnicalEngine: 'Technical Engine', healthTechnicalEngineValue: 'In process · {version}',
    healthYahooChart: 'Yahoo Chart', healthFearGreed: 'Fear & Greed Index',
    analyst: 'Analyst',
    ...
    conflictSummaryExternal: 'The technical signal calls {technicalDirection}, but the fundamental, sentiment and macro context leans {fundamentalDirection}.',
    conflictSummaryBlended: 'Technicals lean {technicalDirection} ({technicalSupporters}/{technicalTotal} signals) but fundamentals lean {fundamentalDirection} ({fundamentalSupporters}/{fundamentalTotal} signals).',
    ...
    technicalStrongBullish: 'Strong bullish', technicalBullish: 'Bullish', technicalStrongBearish: 'Strong bearish', technicalBearish: 'Bearish', technicalMixed: 'Mixed',
    technicalTight: 'Tight', technicalCompressing: 'Compressing', technicalExpanding: 'Expanding', technicalNormal: 'Normal',
    technicalExtremeOversold: 'Extremely oversold', technicalOversold: 'Oversold', technicalWeak: 'Weak', technicalNeutral: 'Neutral', technicalStrong: 'Strong',
    technicalOverbought: 'Overbought', technicalExtremeOverbought: 'Extremely overbought', technicalNone: 'None',
    technicalBullishCross: 'Bullish cross', technicalBearishCross: 'Bearish cross',
    technicalLow: 'Low', technicalElevated: 'Elevated', technicalExtreme: 'Extreme', technicalVeryLow: 'Very low', technicalHigh: 'High',
    technicalSqueeze: 'Squeeze', technicalExpanded: 'Expanded',
    technicalRising: 'Rising', technicalFalling: 'Falling', technicalFlat: 'Flat',
    technicalBearishDivergence: 'Bearish divergence', technicalBullishDivergence: 'Bullish divergence',
    technicalOutperforming: 'Outperforming', technicalUnderperforming: 'Underperforming',
    finalDecision: 'Final decision', finalDecisionHint: 'The technical signal leads. Fundamentals can only lower a mid or long buy. A buy must also beat every benchmark below.',
    ...
    earningsIn: 'Earnings in {days} days ({date})', earningsToday: 'Earnings today ({date})',
    ...
    summaryTechnical: 'Technical: {action} ({priceState})', summaryHurdleBeats: 'beats {benchmarks}', summaryHurdleLags: 'does not beat {benchmarks}',
    ...
    decisionBoardHurdleFilter: 'Only show rows that pass the index hurdle',
  ...
  'zh-Hans': {
    ...
    undervalued: '估值偏低', demandShock: '需求冲击', trending: '趋势中', opportunities: '机会', run: '运行{screen}', running: '运行中...', loadingResults: '正在加载结果...',
    ...
    masterVerdict: '综合结论', masterVerdictConfirms: '与完整分析一致', masterVerdictDiffers: '与完整分析不一致',
    healthTitle: '服务心跳', lastChecked: '最后检查：{time}', refresh: '刷新', healthy: '正常', down: '不可用', core: '核心', dataProviders: '数据源', checking: '检查中…', status: '状态', configValid: '配置有效', cache: '缓存', languageModel: '大语言模型', available: '可用', unavailable: '不可用', unreachable: '无法连接', reachable: '可连接', evidence: '证据', job: '任务', analyst: '分析服务',
    healthTechnicalEngine: '技术引擎', healthTechnicalEngineValue: '进程内运行 · {version}',
    healthYahooChart: '雅虎图表数据', healthFearGreed: '恐慌与贪婪指数',
    ...
    conflictSummaryExternal: '技术信号给出{technicalDirection}，但基本面、市场情绪与宏观面综合来看倾向{fundamentalDirection}。',
    conflictSummaryBlended: '技术面倾向{technicalDirection}（{technicalSupporters}/{technicalTotal} 个信号），但基本面倾向{fundamentalDirection}（{fundamentalSupporters}/{fundamentalTotal} 个信号）。',
    ...
    technicalStrongBullish: '强烈看涨', technicalBullish: '看涨', technicalStrongBearish: '强烈看跌', technicalBearish: '看跌', technicalMixed: '涨跌不一',
    technicalTight: '密集', technicalCompressing: '收窄中', technicalExpanding: '发散中', technicalNormal: '正常',
    technicalExtremeOversold: '极度超卖', technicalOversold: '超卖', technicalWeak: '偏弱', technicalNeutral: '中性', technicalStrong: '偏强',
    technicalOverbought: '超买', technicalExtremeOverbought: '极度超买', technicalNone: '无',
    technicalBullishCross: '金叉', technicalBearishCross: '死叉',
    technicalLow: '偏低', technicalElevated: '偏高', technicalExtreme: '极高', technicalVeryLow: '很低', technicalHigh: '较高',
    technicalSqueeze: '挤压', technicalExpanded: '扩张',
    technicalRising: '上升', technicalFalling: '下降', technicalFlat: '走平',
    technicalBearishDivergence: '顶背离', technicalBullishDivergence: '底背离',
    technicalOutperforming: '跑赢', technicalUnderperforming: '跑输',
    marketStructure: '市场结构', relativeVolume: '相对成交量', fiftyTwoWeekRange: '52 周区间', distanceToHigh: '距高点', distanceToLow: '距低点',
    finalDecision: '最终决策', finalDecisionHint: '以技术面信号为主。基本面只能下调中线或长线的买入。买入还必须跑赢下方每一个基准。',
    ...
    earningsIn: '{days} 天后公布业绩（{date}）', earningsToday: '今日公布业绩（{date}）',
    ...
    moreReasons: '还有 {count} 条',
    summaryTechnical: '技术面：{action}（{priceState}）', summaryHurdleBeats: '跑赢 {benchmarks}', summaryHurdleLags: '跑不赢 {benchmarks}',
    ...
    decisionBoardHurdleFilter: '只显示通过指数门槛的代码',
  ...
  'zh-Hant-HK': {
    ...
    undervalued: '估值偏低', demandShock: '需求衝擊', trending: '趨勢中', opportunities: '機會', run: '執行{screen}', running: '執行中...', loadingResults: '正在載入結果...',
    ...
    masterVerdict: '綜合結論', masterVerdictConfirms: '與完整分析一致', masterVerdictDiffers: '與完整分析不一致',
    healthTitle: '服務狀態', lastChecked: '最後檢查：{time}', refresh: '重新整理', healthy: '正常', down: '無法運作', core: '核心', dataProviders: '資料供應商', checking: '檢查中…', status: '狀態', configValid: '設定有效', cache: '快取', languageModel: 'LLM', available: '可用', unavailable: '不可用', unreachable: '無法連接', reachable: '可連接', evidence: '證據', job: '工作', analyst: '分析服務',
    healthTechnicalEngine: '技術引擎', healthTechnicalEngineValue: '進程內運行 · {version}',
    healthYahooChart: '雅虎圖表數據', healthFearGreed: '恐慌與貪婪指數',
    ...
    conflictSummaryExternal: '技術信號給出{technicalDirection}，但基本因素、市場情緒與宏觀面綜合來看傾向{fundamentalDirection}。',
    conflictSummaryBlended: '技術面傾向{technicalDirection}（{technicalSupporters}/{technicalTotal} 個訊號），但基本因素傾向{fundamentalDirection}（{fundamentalSupporters}/{fundamentalTotal} 個訊號）。',
    ...
    technicalStrongBullish: '強烈看漲', technicalBullish: '看漲', technicalStrongBearish: '強烈看跌', technicalBearish: '看跌', technicalMixed: '好淡不一',
    technicalTight: '密集', technicalCompressing: '收窄中', technicalExpanding: '發散中', technicalNormal: '正常',
    technicalExtremeOversold: '極度超賣', technicalOversold: '超賣', technicalWeak: '偏弱', technicalNeutral: '中性', technicalStrong: '偏強',
    technicalOverbought: '超買', technicalExtremeOverbought: '極度超買', technicalNone: '無',
    technicalBullishCross: '金叉', technicalBearishCross: '死叉',
    technicalLow: '偏低', technicalElevated: '偏高', technicalExtreme: '極高', technicalVeryLow: '很低', technicalHigh: '較高',
    technicalSqueeze: '擠壓', technicalExpanded: '擴張',
    technicalRising: '上升', technicalFalling: '下跌', technicalFlat: '走平',
    technicalBearishDivergence: '頂背離', technicalBullishDivergence: '底背離',
    technicalOutperforming: '跑贏', technicalUnderperforming: '跑輸',
    marketStructure: '市場結構', relativeVolume: '相對成交量', fiftyTwoWeekRange: '52 週區間', distanceToHigh: '距高點', distanceToLow: '距低點',
    finalDecision: '最終決策', finalDecisionHint: '以技術面訊號為主。基本因素只能調低中線或長線的買入。買入亦必須跑贏下方每一個基準。',
    ...
    earningsIn: '{days} 日後公布業績（{date}）', earningsToday: '今日公布業績（{date}）',
    ...
    moreReasons: '還有 {count} 項',
    summaryTechnical: '技術面：{action}（{priceState}）', summaryHurdleBeats: '跑贏 {benchmarks}', summaryHurdleLags: '跑不贏 {benchmarks}',
    ...
    decisionBoardHurdleFilter: '只顯示達到指數門檻的代碼',
